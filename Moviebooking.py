...
def reg():
    ...
    l1=Label(screen,text="Enter Your SignUp Details",bg="red",fg="white",height='2',
          font=label_font,width=label_width)
    l1.pack(pady=10)

    Label(screen,text='Enter Your Username',font=('Gill Sans', 14, 'bold'),
          bg="white",fg="black",height='2',width='30').pack()
    ...
    reopen_button=Button(screen,text="Back",font=('Arial', 9, 'bold'), width=8, height=1, bd=1,bg='white', fg='black',
...
def login():
    ...
    l2=Label(login_screen,text="Enter Your Login Details",bg="red",fg="white",height='2',
          font=label_font,width=label_width)
    l2.pack(pady=10)
...
def selectcity():
    ...
    label = Label(city, textvariable=lbl_text, height=1,width=label_width,
          font=label_font,bg='red',fg='white')
    label.pack()
...
def movies_list(city):
    ...
    btn1=Button(city,text='Jurassic Park', **button_style1(),command=lambda: seat_selection(city,"Jurassic Park"))
    btn1.pack(side=LEFT, padx=15, pady=10, anchor=CENTER)

    btn2=Button(city,text='Mission Impossible', **button_style1(),command=lambda: seat_selection(city,"Mission Impossible"))
    btn2.pack(side=LEFT, padx=15, pady=10, anchor=CENTER)
    
    btn3=Button(city,text='Titanic', **button_style1(),command=lambda: seat_selection(city,"Titanic"))
...
def seat_selection(city,movie_name_fetch):
    ...
    Label(seat,text="Screen",bg="white",fg="red",font=('Gill Sans', 9, 'bold')).place(x=255,y=265)
    canvas = Canvas(seat, width=200, height=10, bg="blue")
    ...
    Label(seat,text="A",bg="white",fg="red",font=font_new).place(x=10,y=70)
    Label(seat,text="B",bg="white",fg="red",font=font_new).place(x=10,y=100)
    Label(seat,text="C",bg="white",fg="red",font=font_new).place(x=10,y=130)
    Label(seat,text="D",bg="white",fg="red",font=font_new).place(x=10,y=160)
    Label(seat,text="E",bg="white",fg="red",font=font_new).place(x=10,y=190)
    Label(seat,text="F",bg="white",fg="red",font=font_new).place(x=10,y=220)

    
    Label(seat,text="1",bg="white",fg="red",font=font_new).place(x=52,y=40)
    Label(seat,text="2",bg="white",fg="red",font=font_new).place(x=82,y=40)
    Label(seat,text="3",bg="white",fg="red",font=font_new).place(x=112,y=40)
    Label(seat,text="4",bg="white",fg="red",font=font_new).place(x=142,y=40)
    Label(seat,text="5",bg="white",fg="red",font=font_new).place(x=172,y=40)
    Label(seat,text="6",bg="white",fg="red",font=font_new).place(x=202,y=40)
    Label(seat,text="7",bg="white",fg="red",font=font_new).place(x=232,y=40)
    Label(seat,text="8",bg="white",fg="red",font=font_new).place(x=262,y=40)
    Label(seat,text="9",bg="white",fg="red",font=font_new).place(x=292,y=40)
    Label(seat,text="10",bg="white",fg="red",font=font_new).place(x=320,y=40)
    Label(seat,text="11",bg="white",fg="red",font=font_new).place(x=350,y=40)
    Label(seat,text="12",bg="white",fg="red",font=font_new).place(x=380,y=40)
    Label(seat,text="13",bg="white",fg="red",font=font_new).place(x=410,y=40)
    Label(seat,text="14",bg="white",fg="red",font=font_new).place(x=440,y=40)
    Label(seat,text="15",bg="white",fg="red",font=font_new).place(x=470,y=40)
    Label(seat,text="16",bg="white",fg="red",font=font_new).place(x=500,y=40)
...
def booking_successfully(seat):
    ...
    scrsize(booked)
    booked.configure(bg="white")

    label_font,label_width=labeltext()

    Label(booked,text="Tickets Booked Successfully",bg="red",fg="white",height='2',
    ...
    Label(booked,text="Your Tickets\n~~~~~~~~~~~~~~",bg="white",fg="red",height='3',
          font=label_font,width=label_width).pack()
    
    seat_label = Label(booked, text="Your Seats: " +seat_name, bg="red", fg="black",height='1',
          font=label_font)
    seat_label.pack()

    cost_label = Label(booked, text="Total Cost: " +str(Amount), bg="red", fg="black",height='1',
          font=label_font)
    cost_label.pack()
...
def main_account_screen():
    ...
    main_screen.title('Your Tickets')
    Label(main_screen, text="Movie Mate", bg="red", fg="white", height=2,
          font=label_font, width=label_width).pack()

    Label(main_screen, text='', bg="white").pack()

    btn = Button(main_screen, text='New User', command=reg, **button_style())
    btn.place(relx=0.5, rely=0.5, anchor=CENTER)

    btn1 = Button(main_screen, text='Login', command=login, **button_style())
